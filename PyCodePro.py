...
class PyCodePro:
    ...
    def execute_code(self, source, code, script_file, trigger=None, **kwargs):
        ...
        for name in output_names:
            ...
            # Le nommage cohérent permet de simplifier la récupération
...
NODE_CLASS_MAPPINGS = { "PyCodePro": PyCodePro }
NODE_DISPLAY_NAME_MAPPINGS = { "PyCodePro": "PyCode Pro" }